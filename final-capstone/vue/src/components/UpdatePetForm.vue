<template>
    ...
    <div class="col-sm">
        ...
        <div
          ...
          role="alert2"
          v-if="updatePetErrors"
          >Pet Successfully Updated Added!
        </div> -->
     ...
     <b-form-group class = "pet-info" label="Adopted by:" label-for="adoptedBy" description="(Required)">
          <b-form-datepicker 
            id="adoptedBy"
            v-model="petToUpdate.adoptedBy"
            placeholder="New owner's name here!"
          ></b-form-datepicker>
     </b-form-group>
     <b-form-group class = "pet-info" label="Adoption status:" label-for="isAdopted">
          <b-form-input 
            id="isAdopted"
            v-model="petToUpdate.isAdopted"
            placeholder="Time for a new home?"
          ></b-form-input>
      </b-form-group>  
