<template>
  <b-navbar toggleable="med"  type="dark" variant="warning"> 
    ...
    <div><img class="img" src ="..\assets\MarvelousZoo.png" height="100px"/></div>

    <div>
      <b-link class = "text-dark text-decoration-none" to="logout" v-if="$store.state.token != ''">
      <img src="..\assets\pawPrint.png" class="img" height="20 px"/>Logout</b-link>

      <b-link class = "text-dark text-decoration-none" to="login" v-else>
      <img src="..\assets\pawPrint.png" class="img" height="20 px"/>Login</b-link> |
